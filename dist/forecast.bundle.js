"use strict";
(self["webpackChunkweather_app"] = self["webpackChunkweather_app"] || []).push([["forecast"],{
...
class Forecast {
    constructor(city, temp, condition, local_time) {
        this.city = city;
        this.temp = temp;
    ...
    createFromJSONData(city, jsonForecastData) {
        this.city = city;
        this.temp = jsonForecastData.avgtemp_c;
        this.condition = jsonForecastData.condition.text;
    ...
    getLocalTimeDate() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.local_time), 'EEEE, dd MMM yyyy');
    }

    getLocalTimeHour() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.local_time), 'HH:mm');
    }

    getLocalTimeDay() {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.local_time), 'EEEE');
    }
}
