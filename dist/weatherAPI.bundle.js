...
class weatherAPI {
  ...
  async getWeather() {
    ...
    try {
      ...
      // Current Day
      const currentWeather = new _weather_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.cityParam, data);

      const days = data.forecast.forecastday;
      // Second Day Forecast
      const secondDay = days[1];
      const secondDayWeather = new _forecast_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.cityParam, secondDay);

      // Third Day Forecast
      const thirdDay = days[2];
      const thirdDayWeather = new _forecast_js__WEBPACK_IMPORTED_MODULE_1__["default"](this.cityParam, thirdDay);
...
class Weather {
  ...
  getLastUpdated() {
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.last_updated), 'HH:mm');
  }
