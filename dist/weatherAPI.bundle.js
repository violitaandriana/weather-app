...
class weatherAPI {
    ...
    async getWeather() {
        ...
        try {
            ...
            const currentWeather = new _weather_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.cityParam, currentDay.temp_c, currentDay.condition.text, currentDay.last_updated, data.location.localtime);
